...
class JasminCode(MachineCode):
    ...
    def emitNEW(self, lexeme):
        #lexeme: String
        return JasminCode.INDENT + "new " + str(lexeme) + JasminCode.END

    def emitNEWARRAY(self, lexeme):
        #lexeme: String
        return JasminCode.INDENT + "newarray " + str(lexeme) + JasminCode.END

    def emitANEWARRAY(self, lexeme):
        #lexeme: String
        return JasminCode.INDENT + "anewarray " + str(lexeme) + JasminCode.END
    ...
    def emitINVOKESTATIC(self, lexeme, typ):
        #lexeme: String
        #typ: String
        return JasminCode.INDENT + "invokestatic " + str(lexeme) + str(typ) + JasminCode.END
    ...
    def emitINVOKESPECIAL(self, lexeme=None, typ=None):
        ...
        if lexeme is None and typ is None:
            ...
            return JasminCode.INDENT + "invokespecial " + str(lexeme) + str(typ) + JasminCode.END


    def emitINVOKEVIRTUAL(self, lexeme, typ):
        #lexeme: String
        #typ: String
        return JasminCode.INDENT + "invokevirtual " + str(lexeme) + str(typ) + JasminCode.END
